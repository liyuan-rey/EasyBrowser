================================================================================
    MICROSOFT 基础类库： EasyBrowser 项目概述
===============================================================================

应用程序向导已为您创建了此 EasyBrowser 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 EasyBrowser 应用程序的每个文件的内容摘要。
...
EasyBrowser.h
    ...
    CEasyBrowserApp 应用程序类。

EasyBrowser.cpp
    这是包含应用程序
    类 CEasyBrowserApp 的主应用程序源文件。
...
应用程序向导将创建一个对话框类：
EasyBrowserDlg.h、EasyBrowserDlg.cpp - 对话框
    这些文件包含 CEasyBrowserDlg 类。  此类定义
    应用程序主对话框的行为。  此对话框的模板包含在 
    EasyBrowser.rc 中，而此文件可以在 Microsoft Visual C++ 中进行编辑。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 EasyBrowser.pch 的预编译头文件 (PCH)
